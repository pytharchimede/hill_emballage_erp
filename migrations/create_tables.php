...
try {
    ...
    echo "<ul>\n";
    echo "<li>✅ Vous connecter sur l'interface web : <a href='../web_admin/login.php'>../web_admin/login.php</a></li>\n";
    echo "<li>✅ Tester l'API : <a href='../backend/requests/auth.php'>../backend/requests/auth.php</a></li>\n";
